...
function AdminSidebar() {
  ...
  const desktopLinkClass =
    "flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 text-black hover:bg-slate-800 hover:text-white group";
  const desktopActiveClass =
    "bg-emerald-600 text-white shadow-md shadow-emerald-900/30 hover:bg-emerald-600";

  const mobileLinkClass =
    "relative flex flex-col items-center justify-center gap-1 flex-1 py-2  transition-all duration-200 active:scale-90 active:bg-slate-100";
  const mobileActiveClass = "text-blue-600";
